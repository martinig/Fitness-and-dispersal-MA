...
length(unique(Species_info$species_cleaned)) #140
...
sort(intersect(as.character(mytree$tip.label), unique(Species_info$species_cleaned))) ## 140 names are matching -  got quite a few left to fix
...
sort(intersect(as.character(mytree$tip.label), unique(Species_info$species_cleaned))) ## 140 names are matching - all fixed 
