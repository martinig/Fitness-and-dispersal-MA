...
```{r}
tab_mod <- all_models(mod,  mod = "species_class", type = "normal") #what do I need to put here for the "mod=" argument? 
...
```{r}
tab_mod1 <- all_models(mod1,  mod = "species_class", type = "normal") #what do I need to put here for the "mod=" argument? 
