...
**Figure S25.** Phylogenetic tree (left panel) and species-level effect size estimates (right panel). Significant relationships are indicated with a red asterisk. Dispersal was positive for ruffed grouse (Bonasa umbellus; Zr = 0.27; 95% CI: 0.05 to 0.50) and negative for Tasmanian nativehens (Gallinula mortierii; Zr = -0.23; 95% CI: -0.45 to -0.001) and cougars (Puma concolor; Zr = -0.61, 95% CIs: -0.90 to -0.32).
