...
```{r study duration}
# getting absolute values for effect sizes as we expect shorter years will have more frqtuations
...
anova(mod_dur1, mod_dur2)
```

```{r}
#| fig-cap: "**Figure S15.** Add text."

# homo
#orchard_plot(mod_dur1, mod = "study_duration", xlab = "Effect Size: Zr", group = "paperID", branch.size = 4, angle = 90)
```

```{r}
#| fig-cap: "**Figure S16.** Add text."

# hetero
#orchard_plot(mod_dur2, mod = "study_duration", xlab = "Effect Size: Zr", group = "paperID", branch.size = 4, angle = 90)
```
