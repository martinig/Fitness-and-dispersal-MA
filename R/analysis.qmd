...
# TODO - this seems to create an issue -
...
# saving tab_focusA1 as RDS
saveRDS(tab_focusA1, here("Rdata", "tab_focusA1.RDS"))
...
# homo
mod_confirmA <- rma.mv(yi = abs_yi2, 
                V = VCV_abs,
                mod = ~ confirmation_bias - 1,
                data = dat, 
                random = list(
                ...
                test = "t",
                sparse = TRUE)
summary(mod_confirmA)
r2_ml(mod_confirmA)

# hetero
mod_confirmA1 <- rma.mv(yi = abs_yi2, 
                 V = VCV_abs,
                 ...
                 sparse = TRUE,
                control=list(optimizer="nlminb", rel.tol=1e-8))
summary(mod_confirmA1)


anova(mod_confirmA, mod_confirmA1)

# homo
orchard_plot(mod_confirmA, mod = "confirmation_bias", xlab = "Effect Size: Zr", group = "paperID", branch.size = 4, angle = 90)

# hetero
orchard_plot(mod_confirmA1, mod = "confirmation_bias", xlab = "Effect Size: Zr", group = "paperID", branch.size = 4, angle = 90)
...
tab_confirmA1 <- all_models(mod_focusA1,  mod = "confirmation_bias", type = "hetero")

# saving tab_confirmA1 as RDS
saveRDS(tab_confirmA1, here("Rdata", "tab_confirmA1.RDS"))
        
```

```{r}
tab_confirmA1 <-readRDS(here("Rdata", "tab_confirmA1.RDS"))
