...
```{r}
#| fig-cap: "**Figure S28.** Combined effect of sample size and publication year on effect size. We present mean effect sizes (Zr) along with 95% confidence (thicker dotted lines) and prediction (thinner dotted lines) intervals are depicted along with individual data points (circles) scaled by precision (1/SE). We include k = number of effect sizes (number of studies)."
...
```{r}
#| fig-cap: "**Figure S29.** Leave one study out (sensitivity analysis). We present mean effect sizes (Zr) along with 95% confidence intervals."
...
```{r}
#| fig-cap: "**Figure S30.** Leave one species out (sensitivity analysis). We present mean effect sizes (Zr) along with 95% confidence intervals."
